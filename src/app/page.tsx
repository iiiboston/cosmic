        ...
        <ol className="list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)]">
          <li className="mb-2">
            ...
            <code className="bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5 rounded font-semibold">
              e.g., "A serene lake at sunset"
            </code>
          </li>
          <li>Click the Generate Image button and wait while the AI processes your request</li>
          <li>Your generated image will appear below the form once it's ready</li>
        </ol>
